function [theta, y_h] = linear_regression (dataset, alpha, num_iters, train_frac, alg_flag, verb_flag)
...
%
% example call: [theta, y_h] = linear_regression ('simple_function_1.txt', 0.01, 1000, 0.9, 0, 1);
%
...
%usage: [theta, y_h] = linear_regression ('simple_function_1.txt', 0.01, 1000, 0.9, 0, 1);
